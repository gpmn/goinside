...
// copy from https://github.com/qiniu/qlang/blob/develop/cmd/qshell/qshell.go
import (
	"errors"
	"fmt"
	"io"
...
func qshell(safeMode bool, script string) {
	qall.InitSafe(safeMode)
	qlang.Import("", GoInExports)
